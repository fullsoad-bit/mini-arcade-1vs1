...
// --- CONFIGURACIÓN DE ARCHIVOS (MODIFICADO) ---
app.use(express.static(__dirname)); // Sirve el index.html
app.use('/js', express.static(path.join(__dirname, 'public/js'))); // Sirve los juegos

// ESTA ES LA LÍNEA NUEVA: Permite que el navegador vea pablo.jpg dentro de public
